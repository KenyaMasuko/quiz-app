        ...
        <div class="mt-3 mb-5">
            ...
            <div class="mt-1 ">
                ...
                <div class="input-group flex-nowrap my-2">
                    ...
                    <input name="answer_a" type="text" value="" class="form-control" placeholder="Aの答えを入力"
                        aria-label="回答A" aria-describedby="answer-a">
                </div>
                <div class="input-group flex-nowrap my-2">
                    <div class="input-group-prepend">
                        <span class="input-group-text" id="answer-b">B</span>
                    </div>
                    <input name="answer_b" type="text" value="" class="form-control" placeholder="Bの答えを入力"
                        aria-label="回答B" aria-describedby="answer-b">
                </div>
                <div class="input-group flex-nowrap my-2">
                    <div class="input-group-prepend">
                        <span class="input-group-text" id="answer-c">C</span>
                    </div>
                    <input name="answer_c" type="text" value="" class="form-control" placeholder="Cの答えを入力"
                        aria-label="回答C" aria-describedby="answer-c">
                </div>
                <div class="input-group flex-nowrap my-2">
                    <div class="input-group-prepend">
                        <span class="input-group-text" id="answer-d">D</span>
                    </div>
                    <input name="answer_d" type="text" value="" class="form-control" placeholder="Dの答えを入力"
                        aria-label="回答D" aria-describedby="answer-d">
                </div>
            </div>
        </div>
